...
use App\Models\CaiAnalyseQualiteSols;
use Illuminate\Http\Request;

class CaiAnalyseQualiteSolsController extends Controller
{
    public function index(Request $request)
    {
        $query = CaiAnalyseQualiteSols::where('user_id', $request->user()->id);
    ...
    public function store(Request $request)
    {
        ...
        $record = CaiAnalyseQualiteSols::updateOrCreate(
            [
