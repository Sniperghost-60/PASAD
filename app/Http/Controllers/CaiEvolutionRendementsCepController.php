...
use App\Models\CaiEvolutionRendementsCep;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class CaiEvolutionRendementsCepController extends Controller
{
    public function index(Request $request)
    {
        $query = CaiEvolutionRendementsCep::where('user_id', Auth::id());
    ...
    public function store(Request $request)
    {
        ...
        $record = CaiEvolutionRendementsCep::updateOrCreate(
            [
                'user_id'      => Auth::id(),
