...
use App\Models\CaiEvolutionProduitsChimiques;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;

class CaiEvolutionProduitsChimiquesController extends Controller
{
    public function index(Request $request)
    {
        $query = CaiEvolutionProduitsChimiques::where('user_id', Auth::id());
    ...
    public function store(Request $request)
    {
        ...
        $record = CaiEvolutionProduitsChimiques::updateOrCreate(
            [
                'user_id'      => Auth::id(),
