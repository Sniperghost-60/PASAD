...
return new class extends Migration
{
    ...
    {
        Schema::create('identification_participants_cep', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('speculation')->nullable();
            $table->string('responsabilite_fonction')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('identification_participants_cep');
    }
};
