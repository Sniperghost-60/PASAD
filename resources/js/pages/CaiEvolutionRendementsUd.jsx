...
const COLS = [
    ...
    { key: 'nom_producteur',        label: "Nom et prénoms du Producteur porteur de l'UD", w: 200 },
    { key: 'culture_technologie',   label: 'Culture / Technologie',                w: 130 },
    { key: 'rendement_n1',          label: 'Rendement année n-1',                  w: 130 },
    { key: 'rendement_n_technologie', label: 'Rendement année n avec technologie', w: 155 },
    { key: 'rendement_n_temoin',    label: 'Rendement année n parcelle témoin',    w: 155 },
];

const emptyLigne = () => ({
    commune: '', arrondissement: '', village: '', nom_producteur: '',
    culture_technologie: '', rendement_n1: '', rendement_n_technologie: '', rendement_n_temoin: '',
});
...
export default function CaiEvolutionRendementsUd() {
    ...
    const renderTable = (forPrint = false) => (
        <div style={{ overflowX: 'auto' }}>
            <table style={{ borderCollapse: 'collapse', minWidth: '1150px', width: '100%', fontSize: '13px' }}>
                <thead>
                    <tr>
                        {COLS.map(c => (
                            <th key={c.key} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
                            <div>
                                <div style={{ fontSize: 18, fontWeight: 700, color: AMBER_DARK }}>
                                    Modèle de tableau d'évolution des rendements des UD
                                </div>
                                <div style={{ fontSize: 13, color: '#6b7280', marginTop: 2 }}>
                                    Phase 5 — Évaluation et actualisation du diagnostic | Étape 17
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                                ...
                                <button onClick={() => navigate('/cai/evolution-produits-chimiques')} style={{ background: AMBER_DARK, color: '#fff', border: 'none', borderRadius: 8, padding: '8px 16px', cursor: 'pointer', fontWeight: 600, fontSize: 13 }}>
                                    Suivant →
                                </button>
                            </div>
                        </div>
