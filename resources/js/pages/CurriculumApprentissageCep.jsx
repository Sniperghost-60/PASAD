                    ...
                    {values.map((value, index) => (
                        <div key={index} className="flex gap-2">
                            <select value={value}
                                ...
                                className={`min-w-0 flex-1 rounded-lg border bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-teal-100 ${errors?.[index] ? 'border-red-400 bg-red-50' : 'border-slate-200 focus:border-teal-400'}`}>
                ...
                <div className="p-6 space-y-5">
                    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50 px-6 py-4">
                            ...
                            <button type="button" onClick={() => navigate('/resume-protocoles-experimentations')}
